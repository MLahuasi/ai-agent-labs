...
import { MarkdownChunkingService } from "./chunking/chunker.js";
import { OpenAiEmbeddingClient } from "./embedding/clients/index.js";
...
export async function runIngest(
   ...
   */
  const chunks = await MarkdownChunkingService.getChunks(docsPath);
