...
from config.openia.tools import ask_chat_completion_question


def execute_chat_completion_example(client: OpenAI, model: str) -> None:
    ...
    answer = ask_chat_completion_question(
        client=client,
        model=model,
        messages=messages,
        question=question,
...
def execute_chat_completion_custom_example(client: OpenAI, model: str) -> None:
    ...
    task = ask_chat_completion_question(
        client=client,
        model=model,
        messages=messages,
        question=question,
    ...
    obstacle = ask_chat_completion_question(
        client=client,
        model=model,
        messages=messages,
        question=question,
