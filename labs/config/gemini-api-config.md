...
Un ejemplo minimo con el SDK puede usar esta estructura simplificada:
...
Ejecucion sugerida del laboratorio actual:
...
- El laboratorio de Gemini vive en [`01-api-config/gemini/main.py`](../01-api-config/gemini/main.py).
